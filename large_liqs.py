...
filename = 'binance_large_liqs.csv'

if not os.path.isfile(filename):
    with open(filename, 'w') as f:
        f.write(','.join(['symbol', 'side', 'order_type', 'time_in_force', 'original_quantity', 'price', 'average_price', 'order_status', 'order_last_filled_quantity','order_filled_accumulated_quantity','order_trade_time', 'usd_size'
        ])+ '\n')
        ...
        while True:
            try:
                ...
                if usd_size > 100000: 
                    ...
                    color = 'light_grey' if side == "Sell" else "dark_grey"
